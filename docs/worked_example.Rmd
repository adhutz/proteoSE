...
> New to Bioconductor or the `SummarizedExperiment` class? Skim the companion slide deck (`docs/proteoSE_pipeline_intro.pptx`) first — it explains the one data structure that every step below reads from and writes to.
>
