...
se <- sev2::se_read_in(file = path_to_proteinGroups, sep = "_rep_")
...
se <- sev2::se_read_in(file = path_to_proteinGroups, experimental_design = design)
...
se_GO <- sev2::enrich_go_se(se_diff_spec, col_names = "griesser_heat_vs_no_glom_heat_diff", OrgDb = "org.Hs.eg.db", pvalueCutoff = 0.5)
