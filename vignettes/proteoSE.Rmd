...
se_GO <- proteoSE::enrich_go_se(se_diff_spec,
                                col_names = "griesser_heat_vs_no_glom_heat_diff",
                                OrgDb = "org.Hs.eg.db",
                                pvalueCutoff = 0.5)
...
pipe <- proteoSE::proteoSE_pipeline(se) |>
  ...
  proteoSE::add_step("test_diff", type = "manual", test = "griesser_heat_vs_no_glom_heat") |>
...
all.equal(
  SummarizedExperiment::rowData(replayed)$griesser_heat_vs_no_glom_heat_diff,
  SummarizedExperiment::rowData(se_diff_spec)$griesser_heat_vs_no_glom_heat_diff
)
```
