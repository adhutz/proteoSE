...
```{r impute DEP}
se_imp <- proteoSE::impute_DEP(se_filtered, fun="QRILC")
```
...
se_imp <- proteoSE::impute_DEP(se_randna, randna = rowData(se_randna)$randna, fun = "mixed", mar = "knn", mnar = "QRILC")
```
...
se_GO <- proteoSE::se_GOE(se_diff_spec, col_names = "griesser_heat_vs_no_glom_heat_diff", OrgDb = "org.Hs.eg.db", pvalueCutoff = 0.5)
