...
se <- proteoSE::phos_read_in_int(
  file = system.file("extdata", "example_2_Phospho_STY_Sites.txt", package = "proteoSE"),
  sep  = "_r"
)
...
v1 <- proteoSE::plot_volcano(se_diff, contrast = "gfp_vs_g0", id_col = "name")
v2 <- proteoSE::plot_volcano(se_diff, contrast = "g2_vs_g0", id_col = "name")
...
p_apol1 <- lapply(apol1, function(x) DEP2::plot_single(se_diff, x, type = "centered"))
