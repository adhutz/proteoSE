...
se <- sev2::phos_read_in_int(
  file = system.file("extdata", "example_2_Phospho_STY_Sites.txt", package = "sev2"),
  sep  = "_r"
)
...
se_imp_perseus <- se_norm %>% sev2::impute_DEP(fun = "man")
...
v1 <- sev2:::se_volcano(se_diff, contrast = "gfp_vs_g0", id_col = "name")
v2 <- sev2:::se_volcano(se_diff, contrast = "g2_vs_g0", id_col = "name")
