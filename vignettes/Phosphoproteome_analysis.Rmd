...
se_imp_perseus <- se_norm %>% proteoSE::impute_DEP(fun = "man")
...
v1 <- proteoSE:::se_volcano(se_diff, contrast = "gfp_vs_g0", id_col = "name")
v2 <- proteoSE:::se_volcano(se_diff, contrast = "g2_vs_g0", id_col = "name")
